...
getSymbols("MSFT",from="2009-10-01",to="2019-09-31") # Microsoft 
getSymbols("INTC",from="2009-10-01",to="2019-09-31") #Intel
getSymbols("T",from="2009-10-01",to="2019-09-31")   # AT&T
getSymbols("KO",from="2009-10-01",to="2019-09-31")  # Coca Cola
getSymbols("WMT",from="2009-10-01",to="2019-09-31") #Walmart
...
################################
quantiles<- final_mat[500,-1]%>%as.numeric()%>%quantile(probs=c(0.005, 0.025,0.25, 0.5, 0.75, 0.975, 0.995))
quantiles
